...
pub fn _Host_Init_EW_Num() -> MapVec {
    ...
    sys::Map::new(_Int_LI_10P_AC(), _Code_LI_10P_AC());
    sys::Map::new(_Int_LI_28P_S_AC(), _Code_LI_28P_AC_S());
    sys::Map::new(_Int_LI_52P_S_AC(), _Code_LI_52P_AC_S());
    sys::Map::new(_Int_LI_28P_AC(), _Code_LI_28P());
    sys::Map::new(_Int_LI_28P_DC(), _Code_LI_28P());
    sys::Map::new(_Int_LI_52P_AC(), _Code_LI_52P());
    sys::Map::new(_Int_LI_52P_DC(), _Code_LI_52P());
    sys::Map::new(_Int_LI_10P_PWR_AC(), _Code_LI_10P_PWR_AC());
    sys::Map::new(_Int_LI_28P_PWR_AC(), _Code_LI_28P_PWR_AC());
    sys::Map::new(_Int_LI_52P_PWR_AC(), _Code_LI_52P_PWR_AC());
    sys::Map::new(_Int_LI_28X_AC(), _Code_LI_28X_AC());
    sys::Map::new(_Int_LI_28X_DC(), _Code_LI_28X_DC());
    sys::Map::new(_Int_LI_28X_24S_AC(), _Code_LI_28X_24S_AC());
    sys::Map::new(_Int_LI_28X_24S_DC(), _Code_LI_28X_24S_DC());
    sys::Map::new(_Int_LI_52X_AC(), _Code_LI_52X_AC());
    sys::Map::new(_Int_LI_52X_DC(), _Code_LI_52X_DC());
    sys::Map::new(_Int_LI_28X_PWR_AC(), _Code_LI_28X_PWR_AC());
    sys::Map::new(_Int_LI_52X_PWR_AC(), _Code_LI_52X_PWR_AC());
    sys::Map::new(_Int_SI_24TP_AC(), _Code_SI_24TP());
    sys::Map::new(_Int_SI_24TP_DC(), _Code_SI_24TP());
    sys::Map::new(_Int_SI_26X_12S_AC(), _Code_SI_26X_12S_AC());
    sys::Map::new(_Int_SI_48TP_AC(), _Code_SI_48TP());
    sys::Map::new(_Int_SI_48TP_DC(), _Code_SI_48TP());
    sys::Map::new(_Int_SI_24TP_PWR(), _Code_SI_24TP_PWR());
    sys::Map::new(_Int_SI_48TP_PWR(), _Code_SI_48TP_PWR());
    sys::Map::new(_Int_SI_28C(), _Code_SI_28C());
    sys::Map::new(_Int_SI_52C(), _Code_SI_52C());
    sys::Map::new(_Int_SI_28C_PWR(), _Code_SI_28C_PWR());
    sys::Map::new(_Int_SI_52C_PWR(), _Code_SI_52C_PWR());
    sys::Map::new(_Int_EI_28C(), _Code_EI_28C());
    sys::Map::new(_Int_EI_28C_24S(), _Code_EI_28C_24S());
    sys::Map::new(_Int_EI_52C(), _Code_EI_52C());
    sys::Map::new(_Int_EI_28C_PWR(), _Code_EI_28C_PWR());
    sys::Map::new(_Int_EI_52C_PWR(), _Code_EI_52C_PWR());
    sys::Map::new(_Int_EI_52C_5710(), _Code_EI_52C_10());
    sys::Map::new(_Int_EI_28C_5710(), _Code_EI_28C_10());
    sys::Map::new(_Int_EI_28C_PWR_AC_10(), _Code_EI_28C_PWR_AC_10());
    sys::Map::new(_Int_EI_52C_PWR_5710(), _Code_EI_52C_PWR_10());
    sys::Map::new(_Int_EI_52C_PWR_AC_10(), _Code_EI_52C_PWR_AC_10());
    sys::Map::new(_Int_HI_28C(), _Code_HI_28C());
    sys::Map::new(_Int_HI_28C_24S(), _Code_HI_28C_24S());
    sys::Map::new(_Int_HI_108C_PWR_5710(), _Code_HI_108C_PWR());
    sys::Map::new(_Int_HI_108C_PWR_5710_B1(), _Code_10HI_108C_PWR_B1());
    sys::Map::new(_Int_LI_28P_BAT(), _Code_LI_28P_BAT());
    sys::Map::new(_Int_LI_28P_4AH(), _Code_LI_28P_4AH());
    sys::Map::new(_Int_LI_28P_24S_BAT(), _Code_LI_28P_24S_BAT());
    sys::Map::new(_Int_LI_28P_24S_4AH(), _Code_LI_28P_24S_4AH());
    sys::Map::new(_Int_LI_28X_AC_5701(), _Code_LI_28X_AC_01());
    sys::Map::new(_Int_LI_28X_24S_AC_01(), _Code_LI_28X_24S_AC_01());
    sys::Map::new(_Int_LI_52X_48CS_AC(), _Code_LI_52X_48CS_AC());
    sys::Map::new(_Int_SI_24TP_PWR_AC(), _Code_SI_24TP_PWR_AC());
    sys::Map::new(_Int_SI_48TP_PWR_AC(), _Code_SI_48TP_PWR_AC());
    sys::Map::new(_Int_SI_28C_AC(), _Code_SI_28C_AC());
    sys::Map::new(_Int_SI_52C_AC(), _Code_SI_52C_AC());
    sys::Map::new(_Int_EI_28C_AC(), _Code_EI_28C_AC());
    sys::Map::new(_Int_EI_28C_24S_AC(), _Code_EI_28C_24S_AC());
    sys::Map::new(_Int_EI_52C_AC(), _Code_EI_52C_AC());
    sys::Map::new(_Int_EI_28C_PWR_AC(), _Code_EI_28C_PWR_AC());
    sys::Map::new(_Int_EI_52C_PWR_AC(), _Code_EI_52C_PWR_AC());
    sys::Map::new(_Int_EI_52C_AC_S5710(), _Code_EI_52C_10_AC());
    sys::Map::new(_Int_EI_28C_AC_S5710(), _Code_EI_28C_10_AC());
    sys::Map::new(_Int_HI_28C_AC(), _Code_HI_28C_AC());
    sys::Map::new(_Int_HI_28C_24S_AC(), _Code_HI_28C_24S_AC());
    sys::Map::new(_Int_LI_28TP_AC(), _Code_LI_28TP_AC());
    sys::Map::new(_Int_LI_28TP_PWR_AC(), _Code_LI_28TP_PWR_AC());
    sys::Map::new(_Int_LI_28TP_PWR_AC_01(), _Code_LI_28TP_PWR_AC_01());
    sys::Map::new(_Int_HI_32C_24S_AC_5720(), _Code_HI_32C_24S_AC_5720());
    sys::Map::new(_Int_HI_56C_AC_5720(), _Code_HI_56C_AC_5720());
    sys::Map::new(_Int_HI_56C_PWR_AC_5720(), _Code_HI_56C_PWR_AC_5720());
    sys::Map::new(_Int_5720EI_36C_28S_AC(), _code_5720EI_36C_28S_AC());
    sys::Map::new(_Int_5720EI_56C_48S_AC(), _code_5720EI_56C_48S_AC());
    sys::Map::new(_Int_5720EI_36C_AC(), _code_5720EI_36C_AC());
    sys::Map::new(_Int_5720EI_36PC_AC(), _code_5720EI_36PC_AC());
    sys::Map::new(_Int_5720EI_56C_AC(), _code_5720EI_56C_AC());
    sys::Map::new(_Int_5720EI_56PC_AC(), _code_5720EI_56PC_AC());
    sys::Map::new(_Int_5720EI_36C_PWR_AC(), _code_5720EI_36C_PWR_AC());
    sys::Map::new(_Int_5720EI_56C_PWR_AC(), _code_5720EI_56C_PWR_AC());
    sys::Map::new(_Int_5720EI_56C_PWR_AC1(), _code_5720EI_56C_PWR_AC1());
    sys::Map::new(_Int_5720EI_32X_24S_AC(), _code_5720EI_32X_24S_AC());
    sys::Map::new(_Int_5720EI_50X_46S_AC(), _code_5720EI_50X_46S_AC());
    sys::Map::new(_Int_5720EI_32X_AC(), _code_5720EI_32X_AC());
    sys::Map::new(_Int_5720EI_32P_AC(), _code_5720EI_32P_AC());
    sys::Map::new(_Int_5720EI_50X_AC(), _code_5720EI_50X_AC());
    sys::Map::new(_Int_5720EI_52X_AC(), _code_5720EI_52X_AC());
    sys::Map::new(_Int_5720EI_52P_AC(), _code_5720EI_52P_AC());
//    sys::Map::new(_Int_00S_28X_LI_AC(), _code_00S_28X_LI_AC());
//    sys::Map::new(_Int_00S_52X_LI_AC(), _code_00S_52X_LI_AC());
//    sys::Map::new(_Int_00S_28P_PWR_LI_AC(), _code_00S_28P_PWR_LI_AC());
//    sys::Map::new(_Int_10_28X_LI_AC(), _code_10_28X_LI_AC());
//    sys::Map::new(_Int_10_52X_LI_AC(), _code_10_52X_LI_AC());
//    sys::Map::new(_Int_20S_28P_SI_AC(), _code_20S_28P_SI_AC());
//    sys::Map::new(_Int_20S_28X_SI_AC(), _code_20S_28X_SI_AC());
//    sys::Map::new(_Int_20S_52P_SI_AC(), _code_20S_52P_SI_AC());
//    sys::Map::new(_Int_20S_52X_SI_AC(), _code_20S_52X_SI_AC());
//    sys::Map::new(_Int_20_28P_SI_AC(), _code_20_28P_SI_AC());
//    sys::Map::new(_Int_20_28X_SI_AC(), _code_20_28X_SI_AC());
//    sys::Map::new(_Int_20_52P_SI_AC(), _code_20_52P_SI_AC());
//    sys::Map::new(_Int_20_52X_SI_AC(), _code_20_52X_SI_AC());
//    sys::Map::new(_Int_20_28X_PWR_SI_AC(), _code_20_28X_PWR_SI_AC());
//    sys::Map::new(_Int_20_52X_PWR_SI_AC(), _code_20_52X_PWR_SI_AC());
//    sys::Map::new(_Int_20_52X_PWR_SI_ACF(), _code_20_52X_PWR_SI_ACF());
//    sys::Map::new(_Int_20_28X_PWR_SI_DC(), _Code_20_28X_PWR_SI_DC());
//    sys::Map::new(_Int_20_52X_PWR_SI_DC(), _Code_20_52X_PWR_SI_DC());
//    sys::Map::new(_Int_20_28X_SI_DC(), _Code_20_28X_SI_DC());
//    sys::Map::new(_Int_20_52X_SI_DC(), _Code_20_52X_SI_DC());
//    sys::Map::new(_Int_20S_28X_SI_DC(), _Code_20S_28X_SI_DC());
//    sys::Map::new(_Int_20S_52X_SI_DC(), _Code_20S_52X_SI_DC());
//    sys::Map::new(_Int_5720EI_32X_DC(), _Code_5720EI_32X_DC());
//    sys::Map::new(_Int_5720EI_50X_DC(), _Code_5720EI_50X_DC());
//    sys::Map::new(_Int_5720EI_32X_24S_DC(), _Code_5720EI_32X_24S_DC());
//    sys::Map::new(_Int_5720EI_50X_46S_DC(), _Code_5720EI_50X_46S_DC());
//    sys::Map::new(_Int_5720EI_36C_DC(), _Code_5720EI_36C_DC());
//    sys::Map::new(_Int_5720EI_56C_DC(), _Code_5720EI_56C_DC());
//    sys::Map::new(_Int_5720EI_36C_PWR_DC(), _Code_5720EI_36C_PWR_DC());
//    sys::Map::new(_Int_5720EI_56C_PWR_DC(), _Code_5720EI_56C_PWR_DC());
//    sys::Map::new(_Int_5720EI_36C_28S_DC(), _Code_5720EI_36C_28S_DC());
//    sys::Map::new(_Int_5720EI_56C_48S_DC(), _Code_5720EI_56C_48S_DC());
//    sys::Map::new(_Int_HI_56C_PWR_AC1_20(), _Code_HI_56C_PWR_AC1_20());
//    sys::Map::new(_Int_5700_8P_G(), _Code_5700_8P_G());
//    sys::Map::new(_Int_S5720_14X_PWH_SI_AC(), _Code_S5720_14X_PWH_SI_AC());
//    sys::Map::new(_Int_12TP_AC_LI20(), _Code_12TP_AC_LI20());
//    sys::Map::new(_Int_12TP_AC_LI20S(), _Code_12TP_AC_LI20S());
//    sys::Map::new(_Int_12TP_PWRAC_LI20(), _Code_12TP_PWRAC_LI20());
//    sys::Map::new(_Int_12TP_PWRAC_LI20S(), _Code_12TP_PWRAC_LI20S());
//    sys::Map::new(_Int_28P_AC_LI20(), _Code_28P_AC_LI20());
//    sys::Map::new(_Int_28P_AC_LI20S(), _Code_28P_AC_LI20S());
//    sys::Map::new(_Int_28X_AC_LI20(), _Code_28X_AC_LI20());
//    sys::Map::new(_Int_28X_AC_LI20S(), _Code_28X_AC_LI20S());
//    sys::Map::new(_Int_28X_DC_LI20(), _Code_28X_DC_LI20());
//    sys::Map::new(_Int_28P_PWRAC_LI20(), _Code_28P_PWRAC_LI20());
//    sys::Map::new(_Int_28P_PWRAC_LI20S(), _Code_28P_PWRAC_LI20S());
//    sys::Map::new(_Int_28X_PWRAC_LI20(), _Code_28X_PWRAC_LI20());
//    sys::Map::new(_Int_28X_PWRAC_LI20S(), _Code_28X_PWRAC_LI20S());
//    sys::Map::new(_Int_52P_AC_LI20(), _Code_52P_AC_LI20());
//    sys::Map::new(_Int_52P_AC_LI20S(), _Code_52P_AC_LI20S());
//    sys::Map::new(_Int_52X_AC_LI20(), _Code_52X_AC_LI20());
//    sys::Map::new(_Int_52X_AC_LI20S(), _Code_52X_AC_LI20S());
//    sys::Map::new(_Int_52X_DC_LI20(), _Code_52X_DC_LI20());
//    sys::Map::new(_Int_52P_PWRAC_LI20(), _Code_52P_PWRAC_LI20());
//    sys::Map::new(_Int_52P_PWRAC_LI20S(), _Code_52P_PWRAC_LI20S());
//    sys::Map::new(_Int_52X_PWRAC_LI20(), _Code_52X_PWRAC_LI20());
//    sys::Map::new(_Int_52X_PWRAC_LI20S(), _Code_52X_PWRAC_LI20S());
//    sys::Map::new(_Int_28X_24S_AC_LI20(), _Code_28X_24S_AC_LI20());
//    sys::Map::new(_Int_28X_24S_AC_LI20S(), _Code_28X_24S_AC_LI20S());
//    sys::Map::new(_Int_28X_24S_DC_LI20(), _Code_28X_24S_DC_LI20());
//    sys::Map::new(_Int_28TP_PWRACL_LI20(), _Code_28TP_PWRACL_LI20());
//    sys::Map::new(_Int_28TP_PWRACL_LI20S(), _Code_28TP_PWRACL_LI20S());
//    sys::Map::new(_Int_28TP_PWRAC_LI20(), _Code_28TP_PWRAC_LI20());
//    sys::Map::new(_Int_28TP_AC_LI20(), _Code_28TP_AC_LI20());
//    sys::Map::new(_Int_26X_PWHAC_LI20(), _Code_16X_PWHAC_LI20());
//    sys::Map::new(_Int_28X_PWHAC_LI20(), _Code_28X_PWHAC_LI20());
//    sys::Map::new(_Int_28X_24S_AC_SI20(), _Code_28X_24S_AC_SI20());
//    sys::Map::new(_Int_28X_24S_DC_SI20(), _Code_28X_24S_DC_SI20());
    sys::Map::new(_Int_28X24S_AC_SI21(), _Code_28X24S_AC_SI21());
    sys::Map::new(_Int_52X_PWRACF_LI20(), _Code_52X_PWRACF_LI20());
    sys::Map::new(_Int_48C_AC_SI30(), _Code_48C_AC_SI30());
    sys::Map::new(_Int_48C_PWR_AC_SI30(), _Code_48C_PWR_AC_SI30());
    sys::Map::new(_Int_68C_AC_SI30(), _Code_68C_AC_SI30());
    sys::Map::new(_Int_68C_PWR_AC_SI30(), _Code_68C_PWR_AC_SI30());
    sys::Map::new(_Int_68C_PWR_SI30(), _Code_68C_PWR_SI30());
    sys::Map::new(_Int_48C_AC_EI30S(), _Code_48C_AC_EI30S());
    sys::Map::new(_Int_48C_PWR_EI30S(), _Code_48C_PWR_EI30S());
    sys::Map::new(_Int_68C_AC_EI30S(), _Code_68C_AC_EI30S());
    sys::Map::new(_Int_68C_PWR_EI30S(), _Code_68C_PWR_EI30S());
    sys::Map::new(_Int_20I_12X_SI_AC(), _Code_20I_12X_SI_AC());
    sys::Map::new(_Int_20I_12X_PWH_SI_DC(), _Code_20I_12X_PWH_SI_DC());
    sys::Map::new(_Int_20I_28X_SI_AC(), _Code_20I_28X_SI_AC());
    sys::Map::new(_Int_20I_28X_PWH_SI_AC(), _Code_20I_28X_PWH_SI_AC());
    sys::Map::new(_Int_30_36C_HI(), _Code_30_36C_HI());
    sys::Map::new(_Int_30_44C_HI(), _Code_30_44C_HI());
    sys::Map::new(_Int_30_36C_PWH_HI(), _Code_30_36C_PWH_HI());
    sys::Map::new(_Int_30_44C_PWH_HI(), _Code_30_44C_PWH_HI());
    sys::Map::new(_Int_30_60C_HI(), _Code_30_60C_HI());
    sys::Map::new(_Int_30_68C_HI(), _Code_30_68C_HI());
    sys::Map::new(_Int_30_60C_PWH_HI(), _Code_30_60C_PWH_HI());
    sys::Map::new(_Int_30_68C_PWH_HI(), _Code_30_68C_PWH_HI());
    sys::Map::new(_Int_20SV2_28P_LIAC(), _Code_20SV2_28P_LIAC());
    sys::Map::new(_Int_20SV2_52P_LIAC(), _Code_20SV2_52P_LIAC());
    sys::Map::new(_Int_20I_10XPWH_SI_AC(), _Code_20I_10XPWH_SI_AC());
    sys::Map::new(_Int_20I_6XPWH_SI_AC(), _Code_20I_6XPWH_SI_AC());
    sys::Map::new(_Int_30_60C_HI_48S(), _Code_30_60C_HI_48S());
    sys::Map::new(_Int_30_68C_HI_48S(), _Code_30_68C_HI_48S());
    sys::Map::new(_Int_30_36C_HI_24S(), _Code_30_36C_HI_24S());
    sys::Map::new(_Int_30_44C_HI_24S(), _Code_30_44C_HI_24S());
    sys::Map::new(_Int_20_52X_LI_48S_AC(), _Code_20_52X_LI_48S_AC());
    sys::Map::new(_Int_20_52X_SI_48S(), _Code_20_52X_SI_48S());
    sys::Map::new(_Int_20_28XPWR_LI_ACF(), _Code_20_28XPWR_LI_ACF());
    result
}
